...
bitcore-message-kryfios adds support for verifying and signing kryfios messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-kryfios
```

```sh
bower install bitcore-message-kryfios
```
